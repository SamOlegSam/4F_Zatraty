...
//-------Печать отчёта по затрвтам в .xlsx-----------------------------------------------

function ZatratyExcel() {
    ...
    var stringhref = "/Home/ZatratyExcel?";

    $.ajax({
        url: "/Home/ZatratyExcel",
        type: "POST",
        contentType: "application/json;charset=UTF-8",
        data: JSON.stringify(data),

        success: function () {
            location = '/Report/ReportZatratyExcel.xlsx'
...
//------------------------------------------------------------//
//-------Печать отчёта по филиалам в .xlsx-----------------------------------------------
function FilialyExcel() {
    ...
    var stringhref = "/Home/FilialyExcel?";

    $.ajax({
        url: "/Home/FilialyExcel",
        type: "POST",
        contentType: "application/json;charset=UTF-8",
        data: JSON.stringify(data),

        success: function () {
            location = '/Report/ReportFilialyExcel.xlsx'
...
function SvodExcel() {
    ...
    $.ajax({
        ...
        success: function () {
            location = '/Report/ReportSvodExcel.xlsx'
...
//-------Печать суммарного отчёта в .xlsx-----------------------------------------------
...
function SummExcel() {
    ...
    $.ajax({
        ...
        success: function () {
            location = '/Report/ReportSummExcel.xlsx'
